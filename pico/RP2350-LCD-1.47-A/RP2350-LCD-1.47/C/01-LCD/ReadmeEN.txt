...
1. Basic information:
This example is verified using the RP2350-LCD-1.47 series development board.
You can view the corresponding test examples in the project;

2. Pin connection:
You can check the pin connections in 01-LCD\lib\Config\DEV_Config.c, and repeat them here:
