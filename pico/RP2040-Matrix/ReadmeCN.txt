...
1.基本信息：
本例程用于测试或者演示RP2040-Matrix上WS2812B;

2.管脚连接：
管脚连接你可以在RP2040-Matrix.py查看，这里也再重述一次：
DIN    ->    16

3.基本使用：
    1): 按住RP2040-Matrix板上的Boot按键，将RP2040-Matrix通过Type-C USB线接到电脑的USB接口，然后松开按键。
    ...
    5): 在Thonny IDE中打开Python/RP2040-Matrix.py文件
        然后运行当前脚本（绿色小三角）即可
