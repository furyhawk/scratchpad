...
WIDTH = 8            # WIDTH
HEIGHT = 8           # HIGHT
# Maximum brightness as a percentage (0-100). Adjusts the hardware cap.
MAX_BRIGHTNESS_PERCENT = 30
# LED Brightness MAX:255 scaled by MAX_BRIGHTNESS_PERCENT
LED_BRIGHTNESS = 255 * MAX_BRIGHTNESS_PERCENT // 1000
