...
2. Pin connection:
You can check the pin connection at lcd_example.py, and repeat it here:
RP2040-GEEK 
GND    ->    GND
DIN    ->    11
CLK    ->    10
...
3. Basic use:
    ...
    5): Copy this file to python in the Thonny IDE into RP2040-GEEK and open the lcd_example.py file
