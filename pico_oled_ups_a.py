...
if __name__=='__main__':
    ...
    while True:
        ...
        print("")
        OLED.fill(0x0000)
        OLED.text("Voltage:  {:6.3f} V".format(bus_voltage),1,2,OLED.white)
        OLED.text("Current:  {:6.3f} A".format(current/1000),1,12,OLED.white)
        OLED.text("Percent:  {:6.1f} %".format(P),1,22,OLED.white)  
        OLED.show()
