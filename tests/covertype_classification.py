...
# import requests
# fname = 'covtype.data.gz'
# url = 'https://archive.ics.uci.edu/ml/machine-learning-databases/' + fname
# r = requests.get(url)
...
trainer_config = TrainerConfig(
    auto_lr_find=True, fast_dev_run=False, max_epochs=5, batch_size=512
)
