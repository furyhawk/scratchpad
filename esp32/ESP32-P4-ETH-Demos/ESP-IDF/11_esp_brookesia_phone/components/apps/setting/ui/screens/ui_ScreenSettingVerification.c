...
void ui_ScreenSettingVerification_screen_init(void)
{
    ...
    lv_obj_set_y(ui_LabelScreenSettingVerification, -300);
    ...
    lv_obj_set_y(ui_LabelScreenSettingVerificationSSID, -300);
    ...
    lv_obj_set_y(ui_TextAreaScreenSettingVerificationPassword, -200);
    ...
    lv_obj_set_width(ui_KeyboardScreenSettingVerification, 750);
    lv_obj_set_height(ui_KeyboardScreenSettingVerification, 400);
    lv_obj_set_x(ui_KeyboardScreenSettingVerification, -1);
    lv_obj_set_y(ui_KeyboardScreenSettingVerification, 150);
