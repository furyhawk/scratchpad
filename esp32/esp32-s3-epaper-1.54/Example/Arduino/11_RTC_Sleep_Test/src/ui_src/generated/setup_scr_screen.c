...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_label_1, "RTC-Sleep-Test");
    ...
    lv_label_set_text(ui->screen_label_2, "2025:09:08\n12:20:30");
    lv_label_set_long_mode(ui->screen_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_2, 0, 69);
    lv_obj_set_size(ui->screen_label_2, 200, 43);
    ...
    lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_montserratMedium_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_3, "Sleep");
    lv_label_set_long_mode(ui->screen_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_3, 0, 141);
    lv_obj_set_size(ui->screen_label_3, 200, 21);
    ...
    lv_obj_set_style_text_font(ui->screen_label_3, &lv_font_montserratMedium_21, LV_PART_MAIN|LV_STATE_DEFAULT);
