...
LV_IMAGE_DECLARE(_Music_RGB565A8_200x200);
LV_IMAGE_DECLARE(_droplet_RGB565A8_19x19);
LV_IMAGE_DECLARE(_thermometer_RGB565A8_19x19);
LV_IMAGE_DECLARE(_battery_RGB565A8_19x19);

LV_FONT_DECLARE(lv_font_montserratMedium_67)
LV_FONT_DECLARE(lv_font_montserratMedium_16)
LV_FONT_DECLARE(lv_font_SansCNbold_16)
